...
export const CATALOGO_ESTUDIO: readonly ModeloEscrito[] = [
  {
    ...
    "cuerpo": "Que vengo a aceptar el cargo de defensor/a de {{IMPUTADO}} para el que fui designado/a en autos, jurando desempeñarlo conforme a derecho. Constituyo domicilio procesal en {{DOMICILIO_CONSTITUIDO}} y domicilio electrónico en {{DOMICILIO_ELECTRONICO}}. Solicito se me tenga por parte, se me notifique de todos los actos procesales y se me permita el ejercicio pleno de las facultades que la ley acuerda a esta parte, incluyendo el acceso irrestricto al legajo, la asistencia a todos los actos de la investigación y la proposición de prueba.",
  ...
  },
  {
    ...
    "cuerpo": "Que vengo a interponer recurso de reposición contra el decreto de fecha {{FECHA}}, que dispuso {{DECISION}}, y en subsidio apelación. Agravio: la decisión {{AGRAVIO}}, causando a esta parte un perjuicio de imposible reparación ulterior. Fundamento: {{ARGUMENTO}}. Solicito se revoque por contrario imperio y se disponga {{PETICION}}.",
